...
public class ShockwaveBlockRenderer extends EntityRenderer<ShockwaveBlockEntity> {
	...
	@Override
	public void render(ShockwaveBlockEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(ShockwaveBlockEntity entity) {
