...
public class LPOptions {
    ...
    public static final MValue.MValueFloat SCALE = new ScaleMValueFloat(LPOptions.CATEGORY, LivingPlanet.id("lp_scale"), $ -> Items.PLAYER_HEAD.getDefaultInstance(), 1f, 0.2f, 4.5f);
